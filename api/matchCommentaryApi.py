...
for league_id, league_name in leagues.items():
	...
	for season_id, season_name in league_seasons.items():
		...
		for fixture in data['data']:
			...
			check_path = path + '/data/matchComments/' + league_name
			...
			file_name = check_path + "/matchComments_{}_{}_{}.json".format(league_name, season_name, fixture_id)
