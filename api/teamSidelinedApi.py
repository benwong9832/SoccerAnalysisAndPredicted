...
for league_id, league_name in leagues.items():
	...
	for season_id, season_name in league_seasons.items():
		...
		for team in data['data']:
			...
			count += 1
			print('1063 / ' + str(count) + '  ' + url)
			print(response.text.encode('utf8'))

			check_path = path + '/data/teamsSidelined/' + league_name
			...
			file_name = check_path + "/teamsSidelined_{}_{}_{}.json".format(league_name, season_name, team_name)
			# f = open(file_name, "w+")
