...
for league_id, league_name in leagues.items():
	...
	for season_id, season_name in league_seasons.items():
		...
		for fixture in data['data']:
			...
			check_path = path + '/data/matchLineups/' + league_name
			...
			file_name = check_path + "/matchLineups_{}_{}_{}.json".format(league_name, fixture_datatime, fixture_id)
